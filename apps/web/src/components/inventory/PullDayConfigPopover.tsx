      ...
      <PopoverTrigger
        render={
          <Button
            variant="outline"
            size="icon"
            className="text-[#94a3b8] border-[#e0ddd8] min-w-[44px] min-h-[44px]"
        ...
        <div className="space-y-3">
          ...
          {loading ? (
            ...
            <>
              ...
              {/* Mode toggle */}
              <div className="flex rounded-lg border border-[#e0ddd8] bg-white p-0.5">
                <button
